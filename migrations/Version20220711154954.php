 ...
 */
final class Version20220711154954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, authors VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, page INT DEFAULT NULL, poster_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
