 ...
 */
final class Version20220418165508 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE collections_user (collections_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_E720DB4C242C7AD2 (collections_id), INDEX IDX_E720DB4CA76ED395 (user_id), PRIMARY KEY(collections_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE collections_user ADD CONSTRAINT FK_E720DB4C242C7AD2 FOREIGN KEY (collections_id) REFERENCES collections (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE collections_user ADD CONSTRAINT FK_E720DB4CA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE');
