 ...
 */
final class Version20220225095809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP format, DROP sort');
    }
